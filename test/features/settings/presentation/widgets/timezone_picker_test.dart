...
void main() {
  ...
  setUp(() {
    ...
    when(
      () => userProfileRepository.updateTimeZone(any()),
    ...
    return tester.pumpWidget(
      ProviderScope(
        ...
        child: MaterialApp(
          ...
          home: const Scaffold(body: TimeZonePicker()),
        ),
      ),
    );
  }

  testWidgets('selecting a value calls updateTimeZone with the chosen value', (
    tester,
  ) async {
    await pump(tester);
    ...
    verify(
      () => userProfileRepository.updateTimeZone('Europe/Paris'),
    ).called(1);
  });
}
