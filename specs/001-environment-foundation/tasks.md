...
- [X] T002 Run `flutter create` to bootstrap the project skeleton at the repository root with package name `wrap_my_finances`, targeting iOS 14+ and Android API 24+
